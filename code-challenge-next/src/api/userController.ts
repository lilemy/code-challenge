...
/** 根据 id 获取脱敏用户信息 GET /user/get/vo */
...
/** 分页获取用户列表 POST /user/list */
export async function listUserByPage(
  body: API.UserQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageUser>("/user/list", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
/** 分页获取用户封装列表 POST /user/list/vo */
export async function listUserVoByPage(
  body: API.UserQueryRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageUserVO>("/user/list/vo", {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
